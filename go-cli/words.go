...
func registerSDKWords(r *eng.Registry, client *sdk.CryptolabelSDK) {
...
func runOp(client *sdk.CryptolabelSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
