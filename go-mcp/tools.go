...
type Args struct {
	Entity string         `json:"entity" jsonschema:"address"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CryptolabelSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "cryptolabel_list",
		Description: "List records from Cryptolabel. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "cryptolabel_load",
		Description: "Load a single record from Cryptolabel. " +
...
func runOp(client *sdk.CryptolabelSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CryptolabelSDK, name string) (sdk.CryptolabelEntity, error) {
