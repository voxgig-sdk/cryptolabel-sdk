// Command Cryptolabel-mcp is an MCP server exposing the Cryptolabel
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Cryptolabel_list  — list records of an entity
//	Cryptolabel_load  — load a single record of an entity
//
