...
|---|---|---|
| `ts/` | @voxgig-sdk/cryptolabel-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cryptolabel-sdk \
      --repository voxgig-sdk/cryptolabel-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cryptolabel-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cryptolabel-sdk --id=<id>` removes it.
