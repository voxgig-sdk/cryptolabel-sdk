...
class CryptolabelTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CryptolabelTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CryptolabelTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CryptolabelTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
