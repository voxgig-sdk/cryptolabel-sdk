...
class CryptolabelTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CryptolabelTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CryptolabelTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CryptolabelTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
