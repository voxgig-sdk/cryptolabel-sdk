...
// Cryptolabel SDK idempotency feature
...
class CryptolabelIdempotencyFeature extends CryptolabelBaseFeature
{
    ...
    private function _mutating(CryptolabelContext $ctx): bool
    {
