...
// Cryptolabel SDK metrics feature
...
class CryptolabelMetricsFeature extends CryptolabelBaseFeature
{
    ...
    private function _record(CryptolabelContext $ctx, bool $ok): void
    {
