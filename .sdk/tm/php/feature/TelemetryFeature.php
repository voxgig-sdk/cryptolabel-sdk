...
// Cryptolabel SDK telemetry feature
...
class CryptolabelTelemetryFeature extends CryptolabelBaseFeature
{
    ...
    private function _close(CryptolabelContext $ctx, bool $ok): void
    {
