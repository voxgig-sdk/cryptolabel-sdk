...
// Cryptolabel SDK ratelimit feature
...
class CryptolabelRatelimitFeature extends CryptolabelBaseFeature
{
    ...
    private function _acquire(CryptolabelContext $ctx): void
    {
    ...
    private function _track(CryptolabelContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
