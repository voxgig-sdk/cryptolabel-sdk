...
class CryptolabelRbacFeature extends CryptolabelBaseFeature
{
    ...
    private function _required(CryptolabelContext $ctx): ?string
    {
    ...
    private function _reject(CryptolabelContext $ctx, string $required): void
    {
    ...
    private function _track(CryptolabelContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
