...
class CryptolabelCacheFeature extends CryptolabelBaseFeature
{
    ...
    private function _through(CryptolabelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
