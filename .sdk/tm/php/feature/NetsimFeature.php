...
// Cryptolabel SDK netsim feature
...
class CryptolabelNetsimFeature extends CryptolabelBaseFeature
{
    ...
    private function _simulate(CryptolabelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CryptolabelContext $ctx, array $applied): void
    {
        $client = $this->client;
