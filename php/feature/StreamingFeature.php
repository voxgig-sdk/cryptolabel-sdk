...
// Cryptolabel SDK streaming feature
...
class CryptolabelStreamingFeature extends CryptolabelBaseFeature
{
    ...
    private function _iterate(CryptolabelResult $result): \Generator
    {
    ...
    private function _streamable(CryptolabelContext $ctx): bool
    {
