...
// Cryptolabel SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CryptolabelTestFeature extends CryptolabelBaseFeature
{
    ...
    public function init(CryptolabelContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CryptolabelContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = CryptolabelParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CryptolabelContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CryptolabelContext $ctx, $op, $args): array
    {
