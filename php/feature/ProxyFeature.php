...
class CryptolabelProxyFeature extends CryptolabelBaseFeature
{
    ...
    public function init(CryptolabelContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CryptolabelContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
