...
// Cryptolabel SDK timeout feature
...
class CryptolabelTimeoutFeature extends CryptolabelBaseFeature
{
    ...
    private function _with_timeout(CryptolabelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CryptolabelContext $_ctx, float $ms): void
    {
        $client = $this->client;
