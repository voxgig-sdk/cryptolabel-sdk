...
// Cryptolabel SDK clienttrack feature
...
class CryptolabelClienttrackFeature extends CryptolabelBaseFeature
{
    ...
    public function PostConstruct(CryptolabelContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Cryptolabel-SDK';
