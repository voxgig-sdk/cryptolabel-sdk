# Cryptolabel PHP SDK Reference

Complete API reference for the Cryptolabel PHP SDK.
...
#### `CryptolabelSDK::test($testopts = null, $sdkopts = null)`
...
#### `get_utility(): CryptolabelUtility`
