...
class AddressEntity
{
    ...
    /**
     * List Address items matching the given filter.
     *
     * @param AddressListMatch|array|null $reqmatch Match filter (any subset
     *   of Address fields) as an assoc-array; AddressListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Address[]|array A list of Address items as assoc-arrays at
     *   the SDK boundary; throws CryptolabelError on failure (item-5 convention).
     */
