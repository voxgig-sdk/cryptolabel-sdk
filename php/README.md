...
```php
<?php
require_once 'cryptolabel_sdk.php';
...
```php
require_once 'cryptolabel_sdk.php';
$client = new CryptolabelSDK($options);
```
...
```
php/
├── cryptolabel_sdk.php          -- Main SDK class
...
The main class (`cryptolabel_sdk.php`) exports the SDK class
