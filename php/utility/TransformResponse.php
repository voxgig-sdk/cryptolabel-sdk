...
// Cryptolabel SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CryptolabelTransformResponse
{
    public static function call(CryptolabelContext $ctx): mixed
    {
        ...
        $transform = CryptolabelHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
