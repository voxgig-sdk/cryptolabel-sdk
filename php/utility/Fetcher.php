...
// Cryptolabel SDK utility: fetcher

class CryptolabelFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CryptolabelSDK/1.0)';
    ...
    public static function call(CryptolabelContext $ctx, string $fullurl, array $fetchdef): array
    {
