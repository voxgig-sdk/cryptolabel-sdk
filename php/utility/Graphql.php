...
// Cryptolabel SDK utility: graphql
//
...
class CryptolabelGraphql
{
    ...
    // equivalent.
    public static function body(CryptolabelContext $ctx): mixed
    {
    ...
    public static function errors(CryptolabelContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
