...
class CryptolabelTestRunner
{
    ...
    {
        $live = self::getenv('CRYPTOLABEL_TEST_LIVE');
        $override = self::getenv('CRYPTOLABEL_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CRYPTOLABEL_TEST_EXPLAIN');
...
class_alias('CryptolabelTestRunner', 'Runner');
class_alias('CryptolabelHelpers', 'Helpers');
