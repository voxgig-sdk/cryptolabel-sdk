...
// Cryptolabel SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CryptolabelSDK::test)
...
{
    private const SDK_CLASS = 'CryptolabelSDK';
    ...
    private const SDK_BASE = 'cryptolabel_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../cryptolabel_sdk.php';
