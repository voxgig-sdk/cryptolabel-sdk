# Cryptolabel SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CryptolabelSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CryptolabelSDK(...) and CryptolabelSDK.test(...) become
#      CryptolabelSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "cryptolabel_sdk"
_SDK_CLASS = "CryptolabelSDK"
