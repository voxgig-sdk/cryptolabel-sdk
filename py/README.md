...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/cryptolabel-sdk/releases)) or
...
```
py/
├── cryptolabel_sdk.py         -- Main SDK module
