...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/cryptolabel-sdk/releases)),
...
```
lua/
├── cryptolabel_sdk.lua    -- Main SDK module
...
The main module (`cryptolabel_sdk`) exports the SDK constructor
