...
describe("AddressDirect", function()
  it("should direct-load-address", function()
    local setup = address_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-address", setup.live and "live" or "unit")
