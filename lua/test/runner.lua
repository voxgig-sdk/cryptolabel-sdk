...
function runner.env_override(m)
  local live = runner.getenv("CRYPTOLABEL_TEST_LIVE")
  local override = runner.getenv("CRYPTOLABEL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("CRYPTOLABEL_TEST_EXPLAIN")
