...
import (
	...
	vs "github.com/voxgig-sdk/cryptolabel-sdk/go/utility/struct"
)

type AddressEntity struct {
	name    string
	client  *core.CryptolabelSDK
...
func NewAddressEntity(client *core.CryptolabelSDK, entopts map[string]any) *AddressEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AddressEntity) GetName() string { return e.name }
...
func (e *AddressEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AddressEntity) Deleted() bool {
	return e.deleted
}


func (e *AddressEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAddressEntity(e.client, opts)
}

func (e *AddressEntity) Data(args ...any) any {
...
func (e *AddressEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Address; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AddressEntity) DataTyped(data ...Address) Address {
	if len(data) > 0 {
		return typedFrom[Address](e.Data(asMap(data[0])))
	}
	return typedFrom[Address](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Address (all fields
// optional at the wire level).
func (e *AddressEntity) MatchTyped(match ...Address) Address {
	if len(match) > 0 {
		return typedFrom[Address](e.Match(asMap(match[0])))
	}
	return typedFrom[Address](e.Match())
}
...
func (e *AddressEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AddressEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AddressEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AddressListMatch and returns []Address. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AddressEntity) ListTyped(reqmatch AddressListMatch, ctrl map[string]any) ([]Address, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Address](res), nil
}



func (e *AddressEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AddressEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AddressEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AddressEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
