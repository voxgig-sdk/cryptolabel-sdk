# Cryptolabel Golang SDK Reference

Complete API reference for the Cryptolabel Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *CryptolabelSDK`
...
#### `Address(data map[string]any) CryptolabelEntity`
