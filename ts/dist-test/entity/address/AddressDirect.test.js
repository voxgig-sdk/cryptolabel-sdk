...
(0, node_test_1.describe)('AddressDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CryptolabelSDK({
    ...
    (0, node_test_1.test)('direct-load-address', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-address', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["address01", "chain01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.address = 'direct01';
            params.chain = 'direct02';
        }
...
function liveScenariosActive() { return false && process.env.CRYPTOLABEL_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'CRYPTOLABEL_TEST_ADDRESS_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.CryptolabelSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CRYPTOLABEL_TEST_ADDRESS_ENTID'];
    ...
    const client = new __1.CryptolabelSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=AddressDirect.test.js.map