...
function envOverride(m) {
    if ('TRUE' === process.env.CRYPTOLABEL_TEST_LIVE ||
        'TRUE' === process.env.CRYPTOLABEL_TEST_OVERRIDE) {
    ...
    m.CRYPTOLABEL_TEST_EXPLAIN = process.env.CRYPTOLABEL_TEST_EXPLAIN || m.CRYPTOLABEL_TEST_EXPLAIN;
    return m;
}
