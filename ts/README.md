...
- Releases: [https://github.com/voxgig-sdk/cryptolabel-sdk/releases](https://github.com/voxgig-sdk/cryptolabel-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `CryptolabelSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `CryptolabelSDK.test(testopts?, sdkopts?)` | `CryptolabelSDK` | Create a test-mode client. |
...
| `client` | `client(): CryptolabelSDK` | Return the parent SDK client. |
...
cryptolabel/
├── src/
│   ├── CryptolabelSDK.ts        # Main SDK class
