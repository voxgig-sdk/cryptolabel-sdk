# Cryptolabel TypeScript SDK Reference

Complete API reference for the Cryptolabel TypeScript SDK.
...
```ts
new CryptolabelSDK(options?: object)
```
...
#### `CryptolabelSDK.test(testopts?, sdkopts?)`
...
**Returns:** `CryptolabelSDK` instance in test mode.
...
Return the parent `CryptolabelSDK` instance.
