...
module CryptolabelTestRunner
  ...
  def self.env_override(m)
    live = getenv("CRYPTOLABEL_TEST_LIVE")
    override = getenv("CRYPTOLABEL_TEST_OVERRIDE")
    ...
    explain = getenv("CRYPTOLABEL_TEST_EXPLAIN")
    m["CRYPTOLABEL_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CryptolabelTestRunner
Helpers = CryptolabelHelpers
Vs = VoxgigStruct
