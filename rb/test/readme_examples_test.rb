...
#      offline in seeded test mode (CryptolabelSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Cryptolabel_sdk.rb")
  SDK_CLASS = "CryptolabelSDK"
