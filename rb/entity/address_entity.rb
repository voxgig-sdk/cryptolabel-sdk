...
class AddressEntity
  ...
  #
  # @param reqmatch [AddressListMatch, Hash, nil] match filter (any subset of
  #   Address fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Address>, Array] the matching Address items; raises CryptolabelError on failure
